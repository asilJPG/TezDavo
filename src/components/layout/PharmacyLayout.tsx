"use client";
// src/components/layout/PharmacyLayout.tsx
...
const PHARMACY_NAV = [
  { href: "/pharmacy/dashboard", icon: "📊", label: "Заказы" },
  { href: "/pharmacy/inventory", icon: "📦", label: "Склад" },
  { href: "/pharmacy/profile", icon: "🏪", label: "Профиль аптеки" },
];
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="text-gray-700 font-semibold mb-1">
            Доступ только для аптек
          </p>
          <p className="text-gray-400 text-sm mb-4">Войдите как аптека</p>
          <Link
            href="/login"
      ...
      <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-full w-64 bg-white border-r z-40">
        <div className="flex items-center gap-3 px-6 py-5 border-b">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Кабинет аптеки</p>
          </div>
        </div>
